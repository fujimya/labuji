      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item">
            <a href="<?php echo base_url(); ?>Penyelia/home" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>Penyelia/jadwal" class="nav-link">
              <i class="nav-icon fas fa-list"></i>
              <p>
                Jadwal Uji            
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>Penyelia/keluar" class="nav-link">
