      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <form role="form" id="quickForm" action="<?php echo base_url(); ?>Pelanggan/tambah_ujilab" method="post" >
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="exampleInputselect">Jenis Uji</label>
                  <select class="form-control select2"   style="width: 100%;" name="jenis_uji" id="jenis_uji">
