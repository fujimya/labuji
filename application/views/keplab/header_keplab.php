  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        style="opacity: .8">
        <span class="brand-text font-weight-light"><?php $user = $this->session->userdata('user'); echo $user['jabatan']; ?></span>
      </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item">
            <a href="<?php echo base_url(); ?>KepalaLab/home" class="nav-link">
           ...
           <li class="nav-item">
            <a href="<?php echo base_url(); ?>KepalaLab/riwayat" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>KepalaLab/grafik" class="nav-link">
              <i class="nav-icon fas fa-history"></i>
              <p>
                Grafik Uji                
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>KepalaLab/keluar" class="nav-link">
