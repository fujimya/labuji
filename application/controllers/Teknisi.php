...
class Teknisi extends CI_Controller {
	...
	{
		$this->load->view('teknisi/masuk_teknisi');
	}
	...
	public function awal(){
		$data['uji'] = $this->db->query("SELECT
			...
			ON (tbl_pelanggan.id = tbl_uji.id_pelanggan) where status_uji = 'process';")->result();
		$this->load->view('teknisi/header_teknisi');
		$this->load->view('teknisi/home_teknisi',$data);
	...
	public function upload_hasil()
	{
		...
		{
			echo 'File terlalu besar ukurannya, silahkan upload ulang. <a href="'.base_url().'awal" >Klik disini</a> untuk upload ulang';
		}
		else
		{
			$data = array(
